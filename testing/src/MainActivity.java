...
public class MainActivity extends Activity {
    ...
    private float currentSharpen = 0.0f;
    ...
    private void showTuneDialog() {
        ...
        final TextView sharpenLbl = createLabel("Adaptive Sharpening: " + currentSharpen); stretchLayout.addView(sharpenLbl);
        final android.widget.SeekBar sharpenBar = new android.widget.SeekBar(this); sharpenBar.setMax(100); sharpenBar.setProgress((int)(currentSharpen * 100)); stretchLayout.addView(sharpenBar);
        sharpenBar.setOnSeekBarChangeListener(new android.widget.SeekBar.OnSeekBarChangeListener() {
            public void onProgressChanged(android.widget.SeekBar s, int p, boolean b) {
                float val = p / 100.0f;
                sharpenLbl.setText("Adaptive Sharpening: " + String.format("%.2f", val));
                currentSharpen = val;
                if (renderer != null) renderer.setSharpen(val);
            }
            public void onStartTrackingTouch(android.widget.SeekBar s) {} public void onStopTrackingTouch(android.widget.SeekBar s) {}
        });
